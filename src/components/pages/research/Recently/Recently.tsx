      ...
      <Inner className='un_recently_inner'>
        ...
        <article className='un_recentlyCard'>
          <a href='' className='un_recentlyCard_img'>
            <div className='un_recentlyCard_thumb'><Image src='/assets/thumb.jpg' alt='' width={474} height={316} /></div>
            <div className='un_recentlyCard_logo'><Image src='/assets/series_logo.png' alt='' width={150} height={150} /></div>
          </a>
          <div className='un_recentlyCard_body'>
            <a href="" className='un_recentlyCard_content'>
              ...
              <h3 className='un_recentlyCard_title'>スマートフォンの利用と旅行消費に関する調査 2024</h3>
