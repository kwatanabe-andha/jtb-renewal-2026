        ...
        "ColumnsList.useEffect": ()=>{
            const fetchData = {
                "ColumnsList.useEffect.fetchData": async ()=>{
                    const { list, pageInfo } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$fetch$2f$getInsights$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])();
                    if (list) {
                        setLoading(true);
                        setData(list);
                        setInfo(pageInfo);
...
_s(ColumnsList, "AcyT0HLcRGTc1OnSqyWUDgxPsjw=");
_c = ColumnsList;
var _c;
...
//# sourceMappingURL=src_18f7b504._.js.map