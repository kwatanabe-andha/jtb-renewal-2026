...
"[project]/src/fetch/getInsights.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$fetch$2f$getInsights$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/fetch/getInsights.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
        ...
        "ColumnsList.useEffect": ()=>{
            const fetchData = {
                "ColumnsList.useEffect.fetchData": async ()=>{
                    ...
                    const { list, pageInfo } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$fetch$2f$getInsights$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(query);
                    if (list) {
                        setLoading(true);
                        setData(list);
                        setInfo(pageInfo);
...
//# sourceMappingURL=src_6b1e399a._.js.map